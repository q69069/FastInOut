...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'purchase-return-dlv', name: 'PurchaseReturnDlv', component: () => import('../views/PurchaseReturnDlv.vue'), meta: { moduleKey: 'purchases' } },
      ...
      { path: 'messages', name: 'Messages', component: () => import('../views/Messages.vue'), meta: { moduleKey: 'tools' } },
      ...
      { path: 'brand', name: 'Brand', component: () => import('../views/Brand.vue'), meta: { moduleKey: 'products' } },
      { path: 'channel', name: 'Channel', component: () => import('../views/Channel.vue'), meta: { moduleKey: 'customers' } },
      { path: 'customer-level', name: 'CustomerLevel', component: () => import('../views/CustomerLevel.vue'), meta: { moduleKey: 'customers' } },
      // Phase B: 车销流程
      ...
      { path: 'settlement', name: 'Settlement', component: () => import('../views/Settlement.vue'), meta: { moduleKey: 'sales' } }
    ]
  }
]
