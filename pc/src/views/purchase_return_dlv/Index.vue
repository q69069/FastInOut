...
import { getPurchaseReturnDlvs, createPurchaseReturnDlv, getPurchaseReturnDlv, warehouseConfirmPurchaseReturnDlv, financeConfirmPurchaseReturnDlv, deletePurchaseReturnDlv, getProducts, getSuppliers, getWarehouses, getEmployees } from '../../api'
...
const form = ref({
  ...
  status: '',
  discount_amount: 0,
  items: [{ product_id: null, quantity: 1, unit_price: 0, amount: 0, remark: '' }]
})
...
const handleSave = async () => {
  ...
  try {
    ...
    const res = await createPurchaseReturnDlv(data)
