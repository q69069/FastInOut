...
import { getVehicleLoads, createVehicleLoad, confirmVehicleLoad, returnVehicleLoad, getVehicleLoad, getWarehouses, getProducts, getEmployees } from '../../api'
...
const handleSave = async () => {
  ...
  try {
    ...
    const res = await createVehicleLoad(data)
