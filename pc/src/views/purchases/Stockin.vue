    ...
    <el-dialog v-model="detailVisible" title="入库单详情" width="600px">
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item label="状态">
          <el-tag :type="detail.status === 2 ? 'success' : 'warning'">{{ statusMap[detail.status] }}</el-tag>
...
import { getPurchaseStockins, createPurchaseStockin, getPurchaseStockin, confirmPurchaseStockin, getProducts, getSuppliers, getWarehouses, getEmployees } from '../../api'
